   ...
   return (
      <PlayListSelector title={data?.title} all={false}>
         {data?.items?.length > 0 && data?.items.map((e, index) => {
            ...
            return <CarouselItem hiddenTitle isHiddenButton={true} isSwiper={true} key={uuidv4()} artis={false} desc={false} class1={classGird} item={e} />
         })}
