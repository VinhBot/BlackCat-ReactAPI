      ...
      <PlayListSelector title={data?.title}>
         <>
            <div className="col l-4 m-6 c-8">
               {colSong1 && colSong1.map((e) => <NewReleaseitem isRadio key={uuidv4()} item={e}/>)}
            </div>
            <div className="col l-4 m-6 c-8">
               {colSong2 && colSong2.map((e) => <NewReleaseitem isRadio key={uuidv4()} item={e}/>)}
            </div>
            <div className="col l-4 m-0 c-8">
               {colSong3 && colSong3.map((e) => <NewReleaseitem isRadio key={uuidv4()} item={e}/>)}
            </div>
         </>
      </PlayListSelector>
   );
